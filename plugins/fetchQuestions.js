const questions = [{
  ...
  response: 'When you reach 75% of your quota you will receive a notification in the dashboard and by email to let you have time to upgrade your plan, after that when you reach 100% of your quotas your triggers will simply not be executed anymore and when the month is finish they will start again.'
}, {
  title: 'I want just to watch some contracts but don\'t interact with them, is there an offer for me ?',
  response: 'For now the plans have limited number of contracts but we plan to have soon a system with private and public contracts and this limit will only apply to private contract so you will be able to watch as many contracts as you want they will just be public. Think that it\'s like the Github repositories, if you share the knowledge it\'s free ;)'
}, {
